 ...
 *
 *      注：宽或高纠正后，{@link StrokeTextView4#setGravity(int)}会被调用【更新为Gravity.CENTER】，布局文件中设置的Gravity会无效
 */
public class StrokeTextView4 extends AppCompatTextView {
    ...
    public StrokeTextView4(Context context) {
        super(context);
        init();
    }

    public StrokeTextView4(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public StrokeTextView4(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
